...
ggplot(grafico_post_x_1)+ geom_density(aes(x = x, fill = color), alpha = 0.5) + 
  scale_fill_discrete(name = "", labels = c("1 observación - Posterior", "1 observación - Prior")) + scale_y_continuous(name = "Densidad") + scale_x_continuous(name = "Hora de la muerte") + theme(legend.position = "top")
...
ggplot(grafico_post_b0_1)+ geom_density(aes(x = x, fill = color), alpha = 0.5) +  scale_fill_discrete(name = "", labels = c("1 observación - Posterior", "1 observación - Prior")) + scale_x_continuous(name = "beta0") + scale_y_continuous(name = "Densidad") + theme(legend.position = "top")
```
...
ggplot(grafico_post_b1_1)+ geom_density(aes(x = x, fill = color), alpha = 0.5) + 
  scale_fill_discrete(name = "", labels = c("1 observación - Posterior", "1 observación - Prior")) + scale_x_continuous(name = "beta1") + scale_y_continuous(name = "Densidad") + theme(legend.position = "top")
